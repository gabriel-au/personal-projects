 ...
 * 
 */
public class QuantidadeItensInfracaoTipoCommand extends AbstractCommand {

	public TransferObject execute(TransferObject transferObject)
			throws FISCONException {
		// fazer a consulta de lista
		try {
			InfracaoTipoPojo pojo = (InfracaoTipoPojo) transferObject;
			...
			if(pojo.getCodigo()!=null && !pojo.getCodigo().equals("")){
				criteria.add(Restrictions.like("codigo",pojo.getCodigo(),MatchMode.START));
			}
