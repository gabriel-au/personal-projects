...
<div class="underbanner2"><span>Marca/Modelo dos Veículos</span> Ultima atualização 22/04/2010</div>
<div id="tabela">
<table>
<tr>
	<th>Situação</th>
...
<s:url id="editar" action="editar" namespace="/marca_modelo">
...
<s:url id="primeiro" action="listar" namespace="/marca_modelo">
	<s:param name="pagina" value="0"/>
	<s:param name="pojo.nome" value="pojo.nome"/>
</s:url>
<s:url id="anterior" action="listar" namespace="/marca_modelo">
	<s:param name="pagina" value="paginaAnterior"/>
	<s:param name="pojo.nome" value="pojo.nome"/>
</s:url>
<s:url id="proximo" action="listar" namespace="/marca_modelo">
	<s:param name="pagina" value="paginaProxima"/>
	<s:param name="pojo.nome" value="pojo.nome"/>
</s:url>
<s:url id="ultimo" action="listar" namespace="/marca_modelo">
