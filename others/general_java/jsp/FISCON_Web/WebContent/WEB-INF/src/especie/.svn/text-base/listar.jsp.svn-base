...
<div class="underbanner2"><span>Espécies dos Veículos</span> Ultima atualização 22/04/2010</div>
<div id="tabela">
<table>
<tr>
	<th>Situação</th>
...
<s:url id="editar" action="editar" namespace="/especie">
...
<s:url id="primeiro" action="listar" namespace="/especie">
	<s:param name="pagina" value="0"/>
</s:url>
<s:url id="anterior" action="listar" namespace="/especie">
	<s:param name="pagina" value="paginaAnterior"/>
</s:url>
<s:url id="proximo" action="listar" namespace="/especie">
	<s:param name="pagina" value="paginaProxima"/>
</s:url>
<s:url id="ultimo" action="listar" namespace="/especie">
