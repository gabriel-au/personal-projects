...
<div class="titulo">
<a href="<%=request.getContextPath()%>/cargo/" >
...
<div class="arredondado_titulo">Localizar Awb</div>

<form action="resultado.jsp">


<div class="arredondado_chamada">Tipo:</div>

<p><input type="radio" name="tipoData" id="tipoData" value="importacao" class="input_radio" size="0" />
Importação</p>
<p><input type="radio" name="tipoData" id="tipoData" value="exportacao" class="input_radio" size="0" />
Exportação</p>
...
<div class="arredondado_chamada">Terminal:</div>

<div class="arredondado_chamada_simples_center">
<select class="input_select" name="aeroporto">
<option value="Selecione um Aeroporto" selected="selected">Selecione um Terminal</option>
...
<div class="arredondado_chamada">AWB:</div>
<div class="arredondado_chamada_simples_center">
