...
public class AutoInfracaoRefazerDao extends ConexaoBanco<AutoInfracaoPojo> {
	...
	public void executar(String path, String chaveExtracao) throws Exception {
		...
		PreparedStatement stmt = conn.prepareStatement(getSqlConsulta());
		stmt.setString(1, chaveExtracao);
