...
@Proxy(lazy=false)
public class MunicipioPojo extends TransferObject implements
	...
	public MunicipioPojo(String nome) {
		this.nome = nome;
	}
	
	public MunicipioPojo(String nome, String uf) {
		this.nome = nome;
		this.uf = uf;
	}
	
	public MunicipioPojo(Integer id) {
		this.id = id;
	}

	public MunicipioPojo(Integer id, Boolean ativo, Date dataModificacao,
	...
	public MunicipioPojo(Boolean ativo, Date dataModificacao,
			String codigo, String nome, String uf) {
		this.ativo = ativo;
