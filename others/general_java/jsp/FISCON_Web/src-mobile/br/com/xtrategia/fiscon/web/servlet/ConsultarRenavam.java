 ...
 * 
 */
public class ConsultarRenavam extends MobileAction {

	private String pagina;
	private CnhPojo pojo;

	public String consultar(String registro, String placa) {
		String retorno;

		String url = "http://novosite.detran.df.gov.br/veiculos/consultas/consulta-veiculo.jsp?PLACA="+placa+"&RENAVAM="+registro;
