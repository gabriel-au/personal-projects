                            ...
                            <tr>
                                <td class="Title">
                                    <table width='100%' cellspacing='0' cellpadding='0' border='0'>
                                        <tr>
                                            <td class="Title" width="">Ordem de Serviço - Listagem (<%= paginacao.getResultSize()%> Registros - Página <%= pageNumber%> de <%= paginacao.getPageNavigator()%>)</td>
                            ...
                            <tr>
                                <td>
                                    <table width='' cellspacing='0' cellpadding='0' border='0'>
                                        <tr>
                                            <td width="165px" class="Title">Nº OS:</td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select name='prioridadeOS' id='prioridadeOS' class='Select' style='width:250px;'>
                                                    ...
                                                    <option value='1' class='OptionBody1' <%if(prioridade != null && prioridade.equals("1")){ %> selected="selected"<%} %>>MÉDIA</option>
                                        ...
                                        <tr>
                                            ...
                                            <td width="">
                                                <select name='tipoOS' id='tipoOS' class='Select' style='width:250px;'>
                                                    <option value='' class='OptionBody1'>-- SELECIONE --</option>
                                                    <option value='p' class='OptionBody2'<%if (tipoOS != null && tipoOS.equals("p")) {out.print("selected");}%>>Manutenção Preventiva</option>
                                                    <option value='c' class='OptionBody1'<%if (tipoOS != null && tipoOS.equals("c")) {out.print("selected");}%>>Manutenção Corretiva</option>
                                                    <option value='a' class='OptionBody2'<%if (tipoOS != null && tipoOS.equals("a")) {out.print("selected");}%>>Aferição</option>
                                                </select>
                                            </td>
                                        </tr>
                                        <tr>
