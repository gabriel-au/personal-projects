...
public class AutoInfracaoImprimir extends MobileDialog {
	...
	public void init() {
		...
		appendPicture("/icones/pergunta.png", Graphics.HCENTER);
	...
	public void show() {
		try {
			...
			if (Impressora.getInstance().getBluetoothAddress() != null) {
				impressoraEndereco.setLabel("Impressora: "
						+ Impressora.getInstance().getBluetoothAddress());
			} else {
				impressoraEndereco.setLabel("Impressora: Não configurada.");
			}

			numeroAutoInfracao.setLabel("Número Auto Infração: "
					+ AutoInfracaoPojo.getInstance().getNumeroAutoInfracao());

			repaint();
		} catch (BancoDadosException e) {
			showMensagemErro(getTitle(), "Falha ao carregar impressora"
					+ e.getMessage(), this);
			e.printStackTrace();
		} catch (Exception e) {
			showMensagemErro(getTitle(),
					"Falha ao serializar" + e.getMessage(), this);
			e.printStackTrace();
		}
		super.show();
	}
	...
	public void executarRight() {
		...
		try {
			...
			showMensagemErro(getTitle(), "Falha ao parear: " + e.getMessage(),
					this);
			/*
			 * ListaDeviceBluetooth listaDeviceBluetooth = new
			 * ListaDeviceBluetooth(); listaDeviceBluetooth.setPrevScreen(this);
		...
		if (Propriedades.getProperty("ARMAZENAGEM_LOCAL").equals("true")) {
			try {
				...
				AutoInfracaoPojo.getInstance().setStatus(
				 ...
				 * RecuperarAutoInfracao().apagar(new
				 * Passo(AutoInfracaoPojo.getId(), Passo.AUTOINFRACAOIMPRIMIR));
				 */
	...
	public String getFormulario() throws Exception {
		try {
			...
			if (AutoInfracaoPojo.getInstance().getNumeroAutoInfracao() != null) {
				...
				campos.put("<<NUMAUTOINFRACAO>>", AutoInfracaoPojo
			...
			if (AutoInfracaoPojo.getInstance().getInfracaoTipoPojo() != null) {
				...
				if (AutoInfracaoPojo.getInstance().getInfracaoTipoPojo()
						.getCodigo() != null) {
					campos.put("<<CODINFRACAO>>", AutoInfracaoPojo
							.getInstance().getInfracaoTipoPojo().getCodigo());
				} else {
			...
			if (AutoInfracaoPojo.getInstance().getEndereco() != null) {
				if (AutoInfracaoPojo.getInstance().getEndereco().getEndereco() != null) {
					campos.put("<<ENDERECO>>", AutoInfracaoPojo.getInstance()
							.getEndereco().getEndereco());
					// log.debug("Endereço");
				}
				if (AutoInfracaoPojo.getInstance().getEndereco().getBairro() != null) {
					campos.put("<<BAIRRO>>", AutoInfracaoPojo.getInstance()
							.getEndereco().getBairro());
					// log.debug("Bairro");
				}
				if (AutoInfracaoPojo.getInstance().getEndereco()
						.getComplemento() != null) {
					campos.put("<<COMPLEMENTO>>", AutoInfracaoPojo
							.getInstance().getEndereco().getComplemento());
					// log.debug("Complemento");
				} else {
					campos.put("<<COMPLEMENTO>>", "");
				}
				campos.put("<<UFLOCAL>>", AutoInfracaoPojo.getInstance()
						.getEndereco().getUf());
				// log.debug("UF Local");
			}
			 ...
			 * "CONTRAST 0\r\n"; t += "TONE 0\r\n"; t += "SPEED 3\r\n"; t +=
			 * "PAGE-WIDTH 548\r\n"; t += "BAR-SENSE\r\n"; t +=
			 * ";// PAGE 0000000005480880\r\n"; t += "BOX 0 656 546 794 1\r\n";
			 * t += "T Gil08pt.cpf 0 137 39 GOVERNO DO DISTRITO FEDERAL\r\n"; t
			 * +=
			 * "T Gil08pt.cpf 0 138 58 SECRETARIA DE ESTADO DE SEGURANCA PUBLICA\r\n"
			 * ; t +=
			 * "T Gil08pt.cpf 0 138 77 DEPARTAMENTO DE TRANSITO DO DISTRITO FEDERAL\r\n"
			 * ; t += "T Gil08pt.cpf 0 189 628 TIPIFICACAO DA INFRACAO\r\n"; t
			 * += "BOX 0 173 546 231 1\r\n"; t +=
			 * "T Gil08pt.cpf 0 351 197 <<NUMAUTOINFRACAO>>\r\n"; t +=
			 * "T 0 0 348 180 N. do Auto de Infracao\r\n"; t +=
			 * "T 0 0 3 178 Orgao Autuador\r\n"; t +=
			 * "T Gil08pt.cpf 0 20 195 <<ORGAOAUTUADOR>>\r\n"; t +=
			 * "T 0 0 169 178 Codigo do Orgao\r\n"; t +=
			 * "T Gil08pt.cpf 0 199 196 <<CODIGOORGAO>>\r\n"; t +=
			 * "BOX 0 261 544 318 1\r\n"; t +=
			 * "T Gil08pt.cpf 0 170 232 IDENTIFICACAO DO VEICULO\r\n"; t +=
			 * "T 0 0 7 267 Placa\r\n"; t +=
			 * "T Gil08pt.cpf 0 12 282 <<PLACA>>\r\n"; t +=
			 * "T 0 0 408 267 Especie\r\n"; t +=
			 * "T Gil08pt.cpf 0 408 282 <<ESPECIE>>\r\n"; t +=
			 * "T 0 0 80 268 UF\r\n"; t += "T Gil08pt.cpf 0 86 282 <<UF>>\r\n";
			 * t += "T 0 0 120 267 Marca/Modelo\r\n"; t +=
			 * "T Gil08pt.cpf 0 120 282 <<MARCA>>\r\n"; t +=
			 * "T 0 0 7 664 Descricao da Infracao\r\n"; t +=
			 * "T 0 0 157 743 Desdobramento\r\n"; t +=
			 * "T Gil08pt.cpf 0 201 762 <<DESDOBRAMENTO>>\r\n"; t +=
			 * "BOX 1 348 545 463 1\r\n"; t +=
			 * "T Gil08pt.cpf 0 111 319 IDENTIFICACAO DO PROPRIETARIO/ARRENDATARIO\r\n"
			 * ; t += "T 0 0 462 412 UF(CNH)\r\n"; t +=
			 * "T Gil08pt.cpf 0 474 428 <<UFCNH>>\r\n"; t +=
			 * "LINE 0 405 546 405 1\r\n"; t +=
			 * "T 0 0 8 355 Nome do Proprietario/Arrendatario\r\n"; t +=
			 * "T Gil08pt.cpf 0 10 371 <<NOMEPROP>>\r\n"; t +=
			 * "T 0 0 9 412 CPF/CNPJ\r\n"; t +=
			 * "T 0 0 141 411 Nº de Registro da CNH\r\n"; t +=
			 * "T Gil08pt.cpf 0 11 428 <<CPF>>\r\n"; t +=
			 * "T Gil08pt.cpf 0 158 427 <<NUMCNH>>\r\n"; t +=
			 * ";//{{BEGIN-BT\r\n"; t +=
			 * "T Gil08pt.cpf 0 11 684 <<DESCINFRACAO>>\r\n"; t +=
			 * "T Gil08pt.cpf 0 11 704 <<DESCINFRACAOCONT>>\r\n"; t +=
			 * ";//{{END-BT\r\n"; t += "BOX 1 492 545 626 1\r\n"; t +=
			 * "T Gil08pt.cpf 0 49 464 IDENTIFICACAO LOCAL/DATA/HORA DO COMETIMENTO DA INFRACAO\r\n"
			 * ; t += "T 0 0 457 576 UF\r\n"; t +=
			 * "T Gil08pt.cpf 0 456 591 <<UFLOCAL>>\r\n"; t +=
			 * "LINE 1 569 545 569 1\r\n"; t +=
			 * "T 0 0 9 499 Local da Infracao\r\n"; t +=
			 * "T 0 0 37 574 Data\r\n"; t += "T 0 0 233 575 Hora\r\n"; t +=
			 * "T Gil08pt.cpf 0 16 590 <<DATAINFRACAO>>\r\n"; t +=
			 * "T Gil08pt.cpf 0 229 592 <<HORAINFRACAO>>\r\n"; t +=
			 * "LINE 0 736 546 736 1\r\n"; t +=
			 * "T 0 0 5 743 Codigo da Infracao\r\n"; t +=
			 * "T Gil08pt.cpf 0 43 764 <<CODINFRACAO>>\r\n"; t +=
			 * "T 0 0 373 743 Pontuacao da Infracao\r\n"; t +=
			 * "T Gil08pt.cpf 0 434 762 <<PONTUCAO>>\r\n"; t +=
			 * "T 0 0 272 742 Artigo(CTB)\r\n"; t +=
			 * "T Gil08pt.cpf 0 285 761 <<ARTIGOCTB>>\r\n"; t +=
			 * "LINE 328 174 328 231 1\r\n"; t +=
			 * "T Gil08pt.cpf 0 162 143 IDENTIFICACAO DA AUTUACAO\r\n"; t +=
			 * "IL 0 626 545 626 30\r\n"; t += "LINE 401 260 401 317 1\r\n"; t
			 * += "IL 1 143 1 173 545\r\n"; t += "LINE 155 174 155 231 1\r\n"; t
			 * += "LINE 75 261 75 318 1\r\n"; t += "LINE 378 570 378 627 1\r\n";
			 * t += "IL 0 231 545 231 30\r\n"; t +=
			 * "LINE 113 261 113 318 1\r\n"; t += "LINE 437 406 437 463 1\r\n";
			 * t += "IL 0 318 545 318 30\r\n"; t +=
			 * "LINE 127 406 127 463 1\r\n"; t += "LINE 265 737 265 794 1\r\n";
			 * t += "IL 1 462 546 462 30\r\n"; t +=
			 * "LINE 146 569 146 626 1\r\n"; t += "LINE 153 736 153 793 1\r\n";
			 * t += "LINE 365 737 365 794 1\r\n"; t +=
			 * "PCX 23 6 !<logoG.pcx\r\n"; t +=
			 * "T Gil08pt.cpf 0 9 517 <<ENDERECO>>\r\n"; t +=
			 * "T Gil08pt.cpf 0 9 537 <<COMPLEMENTO>>\r\n"; t +=
			 * "T Gil08pt.cpf 0 447 534 <<BAIRRO>>\r\n"; t +=
			 * "BOX 0 793 546 878 1\r\n"; t +=
			 * "T 0 0 190 857 Assinatura do condutor\r\n"; t +=
			 * "LINE 64 849 492 849 1\r\n";
			 */
