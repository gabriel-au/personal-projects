...
<div class="underbanner2"><span>Tipos de Restrição dos Veículos</span> Ultima atualização 22/04/2010</div>
<div id="tabela">
<table>
<tr>
	<th>Situação</th>
...
<s:url id="editar" action="editar" namespace="/restricao_tipo">
...
<s:url id="primeiro" action="listar" namespace="/restricao_tipo">
	<s:param name="pagina" value="0"/>
</s:url>
<s:url id="anterior" action="listar" namespace="/restricao_tipo">
	<s:param name="pagina" value="paginaAnterior"/>
</s:url>
<s:url id="proximo" action="listar" namespace="/restricao_tipo">
	<s:param name="pagina" value="paginaProxima"/>
</s:url>
<s:url id="ultimo" action="listar" namespace="/restricao_tipo">
