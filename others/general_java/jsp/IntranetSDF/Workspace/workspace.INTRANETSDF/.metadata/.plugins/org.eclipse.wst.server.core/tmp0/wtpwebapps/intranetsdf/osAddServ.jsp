...
<table width="779" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td width="549" height="180" colspan="2" valign="top">
        <form method="post" action="addServOS">
            <table width="549" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="Title">
                        <table width='549' cellspacing='0' cellpadding='0' border='0'>
                            <tr>
                                <td class="Title" width="400">Ordem de Serviço - Incluir Serviço Executado</td>
                    ...
                    <td>
                        <table width="549" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" style='border: 1px solid #000000;'>
                            <tr>
                                ...
                                <td colspan="2" class="TableResultTitle" style='border-bottom: 1px solid #000000;'>Serviço Executado:</td>
                            </tr>
                            <tr>
                                <td height="18" width="10">&nbsp;</td>
                                <td class="Title" align="center">
                                    <textarea name='servico' class="TextArea" style='border: 0px solid #000000; background-color:#FFFFFF; width:529px; height: 100px;'></textarea>
                                </td>
                                <td width="10">&nbsp</td>
                            </tr>
                            <tr>
