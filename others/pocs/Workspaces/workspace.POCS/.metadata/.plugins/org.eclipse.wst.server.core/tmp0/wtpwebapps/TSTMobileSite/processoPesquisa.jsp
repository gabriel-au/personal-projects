...
<a href="<%=request.getContextPath()%>/processoDetalhe.jsp" >
<div class="arredondado_chamada_negrito_sem_borda">
Processo
</div>
AIRR - 38640-55.2003.5.03.0003</a>
</div>
<div class="arredondado_link">
<a href="<%=request.getContextPath()%>/processoDetalhe.jsp" >
<div class="arredondado_chamada_negrito">
N&uacute;mero do TRT de Origem
</div>
AI-38640/2003-0003-03.40</a>
</div>
<!-- div class="arredondado_chamada_negrito">
NUP
</div>
...
<div class="arredondado_chamada_simples">
Docatel Telecomunicações Ltda.
</div>
<div class="arredondado_chamada_simples_espaco">
Leonardo Minduri
</div>
</div>
<div class="arredondado">
