                            ...
                            <tr>
                                <td class="Title">
                                    <table width='549' cellspacing='0' cellpadding='0' border='0'>
                                        <tr>
                                            <td class="Title" width="400">Ordem de Serviço - Alterar</td>
                                            ...
                                            <td class="<%= statusStyle%>">
                                                <%
                                                            ...
                                                            if (status.equals("ab")) {
                                                                ...
                                                                out.println("<option value='an' class='OptionBody1'>ANÁLISE</option>");
                                                                ...
                                                                out.println("<option value='an' class='OptionBody1' selected='selected'>ANÁLISE</option>");
                                                                out.println("<option value='ag' class='OptionBody2'>AGUARDANDO</option>");
                                                                out.println("<option value='fc' class='OptionBody1'>FECHADO</option>");
                                                            } else if (status.equals("ag")) {
                                                                out.println("<option value='ab' class='OptionBody2'>ABERTO</option>");
                                            ...
                                            <td class="<%= statusStyle%>">
                                                <%
                                                            ...
                                                            if (prioridadeOS == 0) {
                                                                ...
                                                                out.println("<option value='1' class='OptionBody1'>MÉDIA</option>");
                                                                ...
                                                                out.println("<option value='1' class='OptionBody1' selected='selected'>MÉDIA</option>");
                                                                out.println("<option value='2' class='OptionBody2'>BAIXA</option>");
                                            ...
                                            <td>
                                                <%
                                                            ...
                                                            if (os.getTipoOS().equals("p")) {
                                                                out.println("<option value='p' class='OptionBody2' selected='selected'>Manutenção Preventiva</option>");
                                                                out.println("<option value='c' class='OptionBody1'>Manutenção Corretiva</option>");
                                                                out.println("<option value='a' class='OptionBody2'>Aferição</option>");
                                                            } else if (os.getTipoOS().equals("c")) {
                                                                out.println("<option value='p' class='OptionBody2'>Manutenção Preventiva</option>");
                                                                out.println("<option value='c' class='OptionBody1' selected='selected'>Manutenção Corretiva</option>");
                                                                out.println("<option value='a' class='OptionBody2'>Aferição</option>");
                                                            } else if (os.getTipoOS().equals("a")) {
                                                                out.println("<option value='p' class='OptionBody2'>Manutenção Preventiva</option>");
                                                                out.println("<option value='c' class='OptionBody1'>Manutenção Corretiva</option>");
                                                                out.println("<option value='a' class='OptionBody2' selected='selected'>Aferição</option>");
                                                            } else {
                                                                out.println("<option value='p' class='OptionBody2'>Manutenção Preventiva</option>");
                                                                out.println("<option value='c' class='OptionBody1'>Manutenção Corretiva</option>");
                                                                out.println("<option value='a' class='OptionBody2'>Aferição</option>");
