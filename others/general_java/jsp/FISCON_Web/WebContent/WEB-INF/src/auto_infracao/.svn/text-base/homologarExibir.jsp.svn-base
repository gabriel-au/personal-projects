...
<table>
	...
	<tr><td colspan="2">
		<s:form namespace="/auto_infracao" >
			...
			<s:select list="#{'':'Pendente','Homologada':'Homologar','Descartada':'Desqualificar'}" label="Situação" name="pojo.situacao"/>
		    <s:submit value="Confirmar" action="salvar"/>
		</s:form>
	</td></tr>
	<tr class="alt">
	...
	<tr ><td colspan="2"><i>Identificação do Proprietário</i></td></tr>
	<tr>
	...
	<tr><td colspan="2"><i>Tipificação a infração</i></td></tr>
	<tr>
