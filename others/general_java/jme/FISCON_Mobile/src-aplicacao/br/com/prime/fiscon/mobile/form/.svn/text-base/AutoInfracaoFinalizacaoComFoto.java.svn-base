...
public class AutoInfracaoFinalizacaoComFoto extends MobileDialog {
	...
	public AutoInfracaoFinalizacaoComFoto() {
		super("Finalizar Auto Infração");
	}
	public AutoInfracaoFinalizacaoComFoto(MobileDialog dialog) {
		this();
		this.setPrevScreen(dialog);
	}
	public AutoInfracaoFinalizacaoComFoto(String addressDevice) {
		super("Finalizar Auto Infração");
