...
<table width="779" border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<table width="549" border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td class="Title">Notas Fiscais - Emissão de Notas</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<table width="549" border="0" cellspacing="0" cellpadding="0"
					...
					<tr>
						<td></td>
						<td height="18" class="Title">Endereço:</td>
						<td></td>
					...
					<tr>
						<td></td>
						<td height="18" class="Title">Data de Emissão:</td>
						<td></td>
					...
					<tr>
						<td></td>
						<td height="18" class="Title">Inscrição Estadual:</td>
						<td></td>
			...
			<tr>
				<td>
					...
					<tr>
						<td width="10"></td>
						<td width="220" height="18" class="Title">Código:</td>
						<td width="9"></td>
					...
					<tr>
						<td width="10"></td>
						<td width="220" height="18" class="Title">Alíquota:</td>
						<td width="9"></td>
					...
					<tr>
						<td width="10"></td>
						<td width="220" height="18" class="Title">Preço Unitário:</td>
						<td width="9"></td>
					...
					<tr>
						<td width="10"></td>
						<td width="220" height="18" class="Title">Preço Total:</td>
						<td width="9"></td>
			...
			<tr>
				<td>
					...
					<tr>
						<td width="10"></td>
						<td width="220" height="18" class="Title">Deduções Legais:</td>
						<td width="9"></td>
