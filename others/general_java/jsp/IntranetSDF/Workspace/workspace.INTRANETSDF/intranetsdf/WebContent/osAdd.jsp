        ...
        <table width="779" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                <td class="Title">
                                    <table width='549' cellspacing='0' cellpadding='0' border='0'>
                                        <tr>
                                            <td class="Title" width="400">Ordem de Serviço - Cadastrar</td>
                                ...
                                <%--<td class="Title">Ordem de Serviço - Cadastrar</td>--%>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select name='prioridade_os' id='prioridade_os' class='Select' style='width:250px;'>
                                                    ...
                                                    <option value='1' class='OptionBody1' selected>MÉDIA</option>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select name='tipo_os' id='tipo_os' class='Select' style='width:250px;'>
                                                    ...
                                                    <option value='p' class='OptionBody2'>Manutenção Preventiva</option>
                                                    <option value='c' class='OptionBody1'>Manutenção Corretiva</option>
                                                    <option value='a' class='OptionBody2'>Aferição</option>
                                                </select>
                                            </td>
                                        </tr>
                                        <tr>
            ...
            if (listEquipamentos != null) {
                ...
                out.println("</select>");
                                        ...
                                        <tr>
                                            <td height="18" class="Title">N&deg; de Série:</td>
                                            <td></td>
                                        ...
                                        <tr>
                                            <td height="18" class="Title">N&deg; de Câmera:</td>
                                            <td></td>
