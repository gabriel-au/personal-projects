...
<%
    ...
    if (request.getParameter("idCompra") != null) {
        session.setAttribute("idCompra", request.getParameter("idCompra"));
    }
    ...
    <table width="779" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td width="549" height="180" colspan="2" valign="top">
            <form method="POST" action="uploadCompras" enctype="multipart/form-data">
            <table width="549" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="Title">Processo de Compra - Arquivos - Importar (Etapa 2 de 2)</td>
                </tr>
                <tr>
