...
@Proxy(lazy=false)
public class CorPojo extends TransferObject implements java.io.Serializable {
	...
	public CorPojo(Integer id) {
		this.id = id;
	}

	public CorPojo(Integer id, Boolean ativo, Date dataModificacao,
