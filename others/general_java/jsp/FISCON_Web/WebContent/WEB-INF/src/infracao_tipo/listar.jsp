...
<div class="underbanner2"><span>Tipos de Infrações</span> Ultima atualização 22/04/2010</div>
<div id="tabela">
<table>
<tr>
	<th>Situação</th>
...
<s:url id="editar" action="editar" namespace="/infracao_tipo">
...
<tr  <%i++; if(i%2 == 0){%>class="alt"<%} %>>
	...
	<td><s:property value="amparoLegal"/> </td>
	<td><s:property value="infrator"/> </td>
	<td><s:property value="gravidade"/> </td>
	<td><s:property value="orgao"/> </td>
...
<s:url id="primeiro" action="listar" namespace="/infracao_tipo">
	<s:param name="pagina" value="0"/>
	<s:param name="pojo.nome" value="pojo.nome"/>
	<s:param name="pojo.codigo" value="pojo.codigo"/>
</s:url>
<s:url id="anterior" action="listar" namespace="/infracao_tipo">
	<s:param name="pagina" value="paginaAnterior"/>
	<s:param name="pojo.nome" value="pojo.nome"/>
	<s:param name="pojo.codigo" value="pojo.codigo"/>
</s:url>
<s:url id="proximo" action="listar" namespace="/infracao_tipo">
	<s:param name="pagina" value="paginaProxima"/>
	<s:param name="pojo.nome" value="pojo.nome"/>
	<s:param name="pojo.codigo" value="pojo.codigo"/>
</s:url>
<s:url id="ultimo" action="listar" namespace="/infracao_tipo">
