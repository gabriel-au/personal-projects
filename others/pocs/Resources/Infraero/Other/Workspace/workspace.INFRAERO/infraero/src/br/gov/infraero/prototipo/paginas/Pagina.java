package br.gov.infraero.prototipo.paginas;
...
import br.gov.infraero.prototipo.PadraoPaginas;
...
public class Pagina extends HttpServlet {
	...
	private String getPagina(String parametro, String metodo,Map<String, String> listaParametros,HttpSession session)
		...
		String classeNome = "br.gov.infraero.prototipo.paginas.Pagina" + parametro;
		try {
