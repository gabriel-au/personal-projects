...
<s:url id="exibir" action="exibir" namespace="/auto_infracao">
...
<tr <%i++; if(i%2 == 0){%>class="alt"<%} %>>
	...
	<td><s:a href="%{exibir}"><img border="0" src="<s:url value='/imagens/edit32.png' encode='false' includeParams='none'/>" alt="Editar" /></s:a></td>
</tr>
</s:iterator>
</table>
...
<s:url id="primeiro" action="listar" namespace="/auto_infracao">
	<s:param name="pagina" value="0"/>
</s:url>
<s:url id="anterior" action="listar" namespace="/auto_infracao">
	<s:param name="pagina" value="paginaAnterior"/>
</s:url>
<s:url id="proximo" action="listar" namespace="/auto_infracao">
	<s:param name="pagina" value="paginaProxima"/>
</s:url>
<s:url id="ultimo" action="listar" namespace="/auto_infracao">
