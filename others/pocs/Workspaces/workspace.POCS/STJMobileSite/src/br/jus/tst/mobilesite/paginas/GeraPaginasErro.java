...
public class GeraPaginasErro {
	...
	public static void gerarErro400() throws Exception {
		...
		String texto = "A página que você procura não está disponível no portal móvel do TST. Por favor, verifique se você digitou o endereço corretamente e tente outra vez";
