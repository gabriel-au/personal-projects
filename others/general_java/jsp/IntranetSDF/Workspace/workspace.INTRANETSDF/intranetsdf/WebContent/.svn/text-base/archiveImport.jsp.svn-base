...
<%
    ...
    listaTipos = manterArchiveControl.recuperarTipos();
    ...
    <table width="779" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td width="549" height="180" colspan="2" valign="top">
            <form method="POST" action="archiveUpload.jsp">
            <table width="549" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="Title">Arquivos - Importar (Etapa 1 de 2)</td>
                </tr>
                <tr>
                                    ...
                                    <%
                                        ...
                                        if (listaTipos != null) {
                                            ...
                                            for (int i=0; i < listaTipos.size(); i++) {
                                                arquivoTipo = (ArquivoTipo) listaTipos.get(i);
                                                countResult++;
                                                ...
                                                out.println("<option value='" + arquivoTipo.getId() + "' class='" + optionStyle + "'>");
                                                out.println(arquivoTipo.getDescricao());
                                                out.println("</option>");
                                            }
